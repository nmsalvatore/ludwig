...
class DashboardViewTest(TestCase):
    ...
    Tests included:
        1. Redirect of unauthenticated users
        2. Page load of authenticated users
        3. TODO: Dialogue with most recent post should be the first in the list of user dialogues
        4. TODO: Non-participant dialogues should not show in list of user dialogues
    """
    ...
    def test_page_load_for_authenticated_user(self):
        """
        Dashboard template should successfully load for authenticated
        users.
        """
