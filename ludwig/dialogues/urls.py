...
urlpatterns = [
    ...
    path(
        "<str:dialogue_id>/", views.DialogueDetailView.as_view(), name="dialogue_detail"
    ),
    path("polling/<str:dialogue_id>", views.PollingView.as_view(), name="polling"),
    path(
        "delete/<str:dialogue_id>",
        views.DeleteDialogueView.as_view(),
        name="delete_dialogue",
    ),
    path(
        "toggle-visibility/<str:dialogue_id>",
